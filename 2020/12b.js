// const commands = getCommandsExample()
// console.log(commands)
const endPos = run(getCommands())
console.log(endPos)
...
function parseLine(line) {
  const cmd = line[0]
  const qty = Number(line.slice(1))
  if (['N', 'E', 'S', 'W'].includes(cmd)) {
    return {
      type: 'moveDir',
      dir: cmd,
      qty
